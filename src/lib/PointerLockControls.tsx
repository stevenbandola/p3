...
import { PointerLockControls as PointerLockControlsImpl } from './PointerLockControls/PointerLockControls'
...
export const PointerLockControls: ForwardRefComponent<PointerLockControlsProps, PointerLockControlsImpl> = /* @__PURE__ */ React.forwardRef<
...
>(({ domElement, selector, onChange, onLock, onUnlock, enabled = true, makeDefault, ...props }, ref) => {
  ...
  const controls = React.useMemo(() => new PointerLockControlsImpl(explCamera, explDomElement), [explCamera, explDomElement])
